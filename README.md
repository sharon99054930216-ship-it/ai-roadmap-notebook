...
1.我必須自行安排時間完成的Roadmap中part00~part24的mini-project嗎? 並將練習筆記記錄於此嗎?  
2.您提到說「可以先看 一眼 Roadmap 最後 FIN（以及 它的上一個文字區塊）的内容」，是指說我讀完各段落的文字內容後再完成mini-project嗎?  
3.請問GitHub筆記方式有什麼需要注意的嗎?  
4.您最後提供AI Tools Directory網站是給我參考用的嗎?還是有什麼可以特別注意的地方?  

重點整理  
**1.readmap中的每個part預計花一周完成，part05 part07 part09為重點單元，其餘了解架構 如何運算 基本概念即可。**  
**2.在readmap中讀到VGGT Transformer時，回去看paper，重新理解了多少概念。**  
**3.學習在github中分類筆記 分資料夾 看code。**  
**4.練習使用CLI修改代碼。**  
